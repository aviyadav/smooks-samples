...
public class Main {
    ...
    private void createSqlMapInstance() {
        try {
            ...
            Logger.getLogger(Main.class.getName()).log(Level.SEVERE, null, ex);
            throw new RuntimeException("Error initializing SqlMapConfig class. Cause: " + ex);
        }
    }
    ...
    protected void runSmooksTransformWithIbatis() throws IOException, SAXException, SQLException {
    ...
    protected void runSmooksTransformWithDao() throws IOException, SAXException {
    ...
    protected void runSmooksTransformWithJpa() throws IOException, SAXException {
